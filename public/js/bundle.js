...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxlc2VtaWRkIiwiYSI6ImNrY3dpbnp4ZjBibHUyc3FwcjN1bTU4NWQifQ.aWxKPhZ2op8tXay8P_V2Tw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extent map to include current location
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, location, email, password, passwordConfirm //photo
  ) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
          ...
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                email: email,
                password: password,
                passwordConfirm: passwordConfirm //photo,
...
var stripe = Stripe('pk_test_51H8YN7DFYLIoTzkqHK7SBgDDFt7RKqtCbobnuPS9lBj3Wh3M9asxIxw4vBPHUcFlygdic8x15WrWfADgD027G6ra007qzo8pQm');
...
var logOutBtn = document.querySelector('.nav__el--logout'); // const signUpBtn = document.querySelector('.btn--green ');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('cpassword').value; //const photo = document.getElementById('photo').files[0];

  (0, _signup.signup)(name, location, email, password, passwordConfirm);
});
